...
for x in index:
    if x in animalNames:            
            ...
            X.append(Data[j])
            key.append(x)
#Now X is a list of neuron arrays and y is a list of whether each array has tinnitus
...
mlp = MLPClassifier(hidden_layer_sizes=(50, ), max_iter=100, alpha=1e-3, beta_1 = 0.85, beta_2 =0.99, epsilon = 1e-08,
